...
usage() {
  cat <<'EOF'
Usage: ./scripts/run_all_h100_full.sh [options]

Options:
  --methods <csv>              Methods to run. Default: vanilla,mgrpo,seed,amsb
...
LOG_FILE="$LOG_DIR/h100-full-${RUN_ID}.log"
...
if not rows:
    ...
    print("method\tdataset\tpass@1\tpass@2\tpass@4\tpass@8")
...
log "INFO" "H100 full pipeline completed successfully"
